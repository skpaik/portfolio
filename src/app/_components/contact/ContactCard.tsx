        ...
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
                <div className="lg:col-span-2 lg:py-12">
                    ...
                    <div className="mt-8">
                        {pageContent.phoneNumberList.map((phoneNumber, phoneNumber_index) => {
                            return <a key={phoneNumber_index} href=""
                                      className="text-2xl font-bold text-pink-600">{phoneNumber.type}: {phoneNumber.countryCode} - {phoneNumber.phone} </a>
                        })}
                        {pageContent.addressList.map((address, address_index) => {
                            return <address key={address_index}
                                            className="mt-2 not-italic">{address.type}: {address.house}, {address.road}, {address.country}</address>
                        })}
                    </div>
                </div>
