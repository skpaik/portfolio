...
export async function generateStaticParams() {
    const posts: BlogParams[] = [
        {
            slug: "page1/title-1"
        },
        {
            slug: "blog/page1/title-1"
        },
        {
            slug: "/blog/page1/title-1"
        }
...
export default async function BlogSlug({params: {slug}}: { params: BlogParams }) {
    console.log("slug: "+slug)
    const pageContent: BlogContents = await loadJsonContents(slug)
    return (
        <>
