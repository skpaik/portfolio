            ...
            <PageContents classNames="">
                <article className="rounded-xl border border-gray-700  p-4">
                        ...
                        <div>
                            ...
                            <div className="flow-root">
                                <ul className="-m-1 flex flex-wrap">
                                    {pageContent.items.map((socialContentItem, socialContentItem_index) => {
                                        return <li key={socialContentItem_index} className="p-1 leading-none">
                                            <a href={socialContentItem.url} target="_blank"
                                               className="text-xs font-medium">{socialContentItem.title}</a>
                                        </li>
                                    })}
                                </ul>
                            </div>
                    ...
                    <div className="mt-4 space-y-2 grid lg:grid-cols-2 gap-8 sm:grid-cols-1">
                        {pageContent.items.map((socialContentItem, socialContentItem_index) => {
                            return <SocialCard key={socialContentItem_index} socialContentItem={socialContentItem}
                                               itemHeaders={pageContent.itemHeaders}></SocialCard>
                        })}
                    </div>
                </article>
            </PageContents>
