...
export default function BlogDetail({blogContent, globalContent, currentPage}: Props) {
    return (
        <article className="rounded-xl bg-white ring ring-indigo-50 sm:p-6 lg:p-8">
            <div className=" sm:gap-8">
                <BlogDetailInfo blogContent={blogContent}
                                globalContent={globalContent}
                                currentPage={currentPage}></BlogDetailInfo>
